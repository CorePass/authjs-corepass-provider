...
sequenceDiagram
  ...
  Note over B,S: email (optional). Valid email becomes stored as email; if allowCoreIdInput (default true) then invalid email but valid Core ID becomes stored as coreId
